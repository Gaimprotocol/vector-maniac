    ...
    extend: {
      ...
      colors: {
        ...
        game: {
          ...
          "terrain-accent": "hsl(var(--terrain-accent))",
          stars: "hsl(var(--stars))",
          energy: "hsl(var(--energy-bar))",
          health: "hsl(var(--health-bar))",
          shield: "hsl(var(--shield-bar))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { filter: "drop-shadow(0 0 5px hsl(120 100% 50%))" },
          "50%": { filter: "drop-shadow(0 0 15px hsl(120 100% 50%))" },
        },
        "screen-shake": {
